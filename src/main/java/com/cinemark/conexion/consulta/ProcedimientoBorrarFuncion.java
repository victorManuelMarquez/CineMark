 ...
 * @since 1.0
 */
public final class ProcedimientoBorrarFuncion extends ProcedimientoAlmacenado<Integer> {
    ...
    public ProcedimientoBorrarFuncion(
            @NotNull final String imdb,
            @NotNull final String nombreSala
    ) throws IllegalArgumentException {
        super("borrarFuncion(?,?)", imdb, nombreSala);
