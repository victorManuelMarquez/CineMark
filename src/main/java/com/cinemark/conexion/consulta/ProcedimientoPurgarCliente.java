 ...
 * @since 1.0
 */
public final class ProcedimientoPurgarCliente extends ProcedimientoAlmacenado<Integer> {
     ...
     */
    public ProcedimientoPurgarCliente(@NotNull final String dni) throws IllegalArgumentException {
        super("purgarCliente(?)", dni);
