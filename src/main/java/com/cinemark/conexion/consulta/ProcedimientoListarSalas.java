 ...
 * @since 1.0
 */
public final class ProcedimientoListarSalas extends ProcedimientoAlmacenado<List<List<Object>>> {
     ...
     */
    public ProcedimientoListarSalas(@NotNull Integer fila, @NotNull Integer nroFilas) throws IllegalArgumentException {
        super("listarSalas(?,?)", fila, nroFilas);
