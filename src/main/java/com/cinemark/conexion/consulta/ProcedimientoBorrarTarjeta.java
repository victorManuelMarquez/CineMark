 ...
 * @since 1.0
 */
public final class ProcedimientoBorrarTarjeta extends ProcedimientoAlmacenado<Integer> {
     ...
     */
    public ProcedimientoBorrarTarjeta(@NotNull final String dni) throws IllegalArgumentException {
        super("borrarTarjeta(?)", dni);
