 ...
 * @since 1.0
 */
public final class ProcedimientoBorrarPelicula extends ProcedimientoAlmacenado<Integer> {
    ...
    public ProcedimientoBorrarPelicula(@NotNull final String imdb) throws IllegalArgumentException {
        super("borrarPelicula(?)", imdb);
