 ...
 * @since 1.0
 */
public final class ProcedimientoListarFuncionesEnVenta extends ProcedimientoAlmacenado<List<List<Object>>> {
     ...
     */
    public ProcedimientoListarFuncionesEnVenta(@NotNull final Integer fila, @NotNull final Integer nroFilas) {
        super("listarFuncionesEnVenta(?,?)", fila, nroFilas);
