 ...
 * @since 1.0
 */
public final class ProcedimientoBorrarCliente extends ProcedimientoAlmacenado<Integer> {
     ...
     */
    public ProcedimientoBorrarCliente(@NotNull final String dni) throws IllegalArgumentException {
        super("borrarCliente(?)", dni);
