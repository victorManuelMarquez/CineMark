 ...
 * @since 1.0
 */
public final class ProcedimientoBorrarUsuario extends ProcedimientoAlmacenado<Integer> {
     ...
     */
    public ProcedimientoBorrarUsuario(@NotNull final String dni) throws IllegalArgumentException {
        super("borrarUsuario(?)", dni);
