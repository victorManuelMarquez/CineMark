 ...
 * @since 1.0
 */
public final class ProcedimientoListarPeliculas extends ProcedimientoAlmacenado<List<List<Object>>> {
    ...
    public ProcedimientoListarPeliculas(@NotNull Integer fila, @NotNull Integer nroFilas) throws IllegalArgumentException {
        super("listarPeliculas(?,?)", fila, nroFilas);
