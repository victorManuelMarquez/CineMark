 ...
 * @since 1.0
 */
public final class ProcedimientoPurgarSala extends ProcedimientoAlmacenado<Integer> {
     ...
     */
    public ProcedimientoPurgarSala(@NotNull final String nombreSala) throws IllegalArgumentException {
        super("purgarSala(?)", nombreSala);
